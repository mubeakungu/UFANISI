...
def deposit():
    ...
    if request.method == "POST":
        ...
        tx = Transaction(
            ...
            notes=(
                f"Manual claim via till {till_number} from {phone_number} — "
        ...
        flash(
            f"Thanks! We've recorded your KES {int(amount):,} deposit claim to till {till_number}. "
            f"An admin will confirm it against the till statement shortly.",
            "success",
        )
